<template>
	<button class="tui-btn-class tui-btn" :class="[plain?'tui-'+type+'-outline':'tui-btn-'+(type || 'primary'),getDisabledClass(disabled,type),getShapeClass(shape,plain),getShadowClass(type,shadow,plain)]"
	 :hover-class="getHoverClass(disabled,type,plain)" :style="{width:width,height:height,lineHeight:height,fontSize:size+'px'}"
...
<style>
	...
	.tui-shadow-primary {
		box-shadow: 0 10px 14px 0 rgba(15, 96, 128, 0.14);
	}
	...
	.tui-shadow-danger {
		box-shadow: 0 10px 14px 0 rgba(235, 9, 9, 0.2);
	}
	...
	.tui-shadow-warning {
		box-shadow: 0 10px 14px 0 rgba(252, 135, 45, 0.2);
	}
	...
	.tui-shadow-green {
		box-shadow: 0 10px 14px 0 rgba(53,176,106, 0.2);
	}
	...
	.tui-shadow-blue {
		box-shadow: 0 10px 14px 0 rgba(86,119,252, 0.2);
	}
	...
	.tui-shadow-gray {
		box-shadow: 0 10px 14px 0 rgba(191,191,191, 0.2);
	}
