<template>
	<view class="tui-divider" :style="{height:height+'px'}">
		<view class="tui-divider-line" :style="{width:width,background:getBgColor(gradual,gradualColor,dividerColor)}"></view>
		<view class="tui-divider-text" :style="{color:color,fontSize:size+'px',lineHeight:size+'px',background:bgcolor,fontWeight:bold?'bold':'normal'}">
			<slot></slot>
		</view>
	</view>
</template>
